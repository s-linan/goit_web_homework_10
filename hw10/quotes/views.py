...
#     Quote.objects.filter(pk=note_id).update(done=True)
#     return redirect(to='quotes:root')
#
#
# @login_required
# def delete_quote(request, note_id):
#     Quote.objects.get(pk=note_id).delete()
#     return redirect(to='quotes:root')
#
#
# @login_required
# def set_done_author(request, note_id):
#     Author.objects.filter(pk=note_id).update(done=True)
#     return redirect(to='quotes:root')
#
#
# @login_required
# def delete_author(request, note_id):
#     Author.objects.get(pk=note_id).delete()
#     return redirect(to='quotes:root')
